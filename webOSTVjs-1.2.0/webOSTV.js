window.webOS = function (e) {
    ...
    var d = {}, m = function () {
        ...
        return n = e, (r = [{
            key: "send", value: function (e) {
                var n = e.service, r = void 0 === n ? "" : n, t = e.method, o = void 0 === t ? "" : t, i = e.parameters,
                    s = void 0 === i ? {} : i, a = e.onSuccess, c = void 0 === a ? function () {
                    } : a, l = e.onFailure, f = void 0 === l ? function () {
                    } : l, m = e.onComplete, w = void 0 === m ? function () {
                    } : m, v = e.subscribe, y = void 0 !== v && v;
            ...
            key: "callback", value: function () {
                ...
                if (!this.cancelled) {
                    ...
                    var i = o, s = i.errorCode, a = i.returnValue;
        ...
        request: function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
                n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r = u({ service: e }, n);
            return (new m).send(r)
        }
    };
    ...
    if ("object" === ("undefined" == typeof window ? "undefined" : v(window)) && window.PalmSystem) {
        if (window.navigator.userAgent.indexOf("SmartWatch") > -1) y.watch = !0; else if (window.navigator.userAgent.indexOf("SmartTV") > -1 || window.navigator.userAgent.indexOf("Large Screen") > -1) y.tv = !0; else {
            try {
    ...
    var O = y, V = {}, P = function (e) {
        if (0 === Object.keys(V).length) {
            ...
            V.screenHeight = V.screenHeight || window.screen.height, V.screenWidth = V.screenWidth || window.screen.width, O.tv && (O.jcl ? (new m).send({
                ...
                method: "getConfigs",
                parameters: { configNames: ["tv.nyx.firmwareVersion", "tv.nyx.platformVersion", "tv.hw.panelResolution", "tv.model.modelname"] },
